...
```text
> Discussion 섹션을 작성해줘. 핵심 포인트:
> - 우리 결과에서 exhausted CD8+ T세포가 반응군에서 유의하게 높았음
> - 이는 Zheng et al. (2021)의 NSCLC 단일세포 분석 결과와 일치
> - 그러나 Treg 분포 패턴은 기존 연구와 달랐음 — 가능한 이유 논의
> - 한계점: 샘플 수(30명)가 일반화에 충분하지 않을 수 있음
> - 추후 연구: 공간 전사체 분석으로 세포 간 상호작용 확인 필요
> 2단계에서 선별한 문헌만 인용해줘.
```
