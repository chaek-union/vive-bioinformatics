...
이 장에서 웹 도구를 만들기 전에, 한 가지 질문을 먼저 던져야 한다. **AI 시대에 웹 도구를 만드는 것이 여전히 의미가 있는가?**
...
- **공유와 접근성**: 연구실의 동료나 공동 연구자에게 분석 도구를 공유할 때, "이 URL을 열어보세요"가 "이 CLI 도구를 설치하고 이 명령을 실행하세요"보다 훨씬 간편하다.
